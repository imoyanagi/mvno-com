class UserPhone < ApplicationRecord
	...
	validates :bill, presence: true, length: { maximum: 5 }
	validates :phone_bill, length: { maximum: 5 }
	validates :phone_bill_term, length: { maximum: 2 }, numericality: { greater_than: 0 }
end
